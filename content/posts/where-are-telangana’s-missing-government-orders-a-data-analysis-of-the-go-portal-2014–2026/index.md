---
title: Where Are Telangana’s Missing Government Orders? A Data Analysis of the
  GO Portal (2014–2026)
description: An analysis of the Telangana Government Order portal reveals a
  sharp decline in the number of GOs published online since 2015, raising
  questions about transparency and proactive disclosure under the RTI Act.
summary: Government Orders are the backbone of administrative decision-making.
  However, data from the Telangana GO portal shows a dramatic decline in the
  number of orders published online over the past decade. This article analyses
  the trend and raises important questions about transparency in governance.
date: 2026-03-12T09:55:00.000+05:30
draft: false
post_type: legal-awareness
categories:
  - Transparency
  - RTI Stories
  - Governance
  - Public Policy
tags:
  - Telangana Government Orders  GOIR Portal  RTI Act  Government
...
keywords:
  ...
  - GOIR Telangana
  - RTI transparency Telangana
  - Telangana GO portal analysis
  - Government orders Telangana
  - proactive disclosure RTI
noIndex: false
---
## Introduction

Transparency is a cornerstone of democratic governance. One of the most important tools through which governments communicate policy decisions and administrative actions is the **Government Order (GO)**.
...
Government Orders are critical administrative instruments that:
...
Under **Section 4 of the Right to Information Act, 2005**, governments are required to proactively disclose important information so citizens need not file RTI applications for basic records.
...
Telangana’s neighbouring state Andhra Pradesh publishes Government Orders through its GOIR portal:
...
The declining trend raises several important public interest questions:
...
The declining number of Government Orders published on the Telangana GO portal is a trend that warrants deeper examination.
...
Telangana Government Order Issue Register (GOIR)
